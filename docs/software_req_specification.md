...
4. [Специфические требования](#specific-requirements)  
	...
	4.3. [Требования к интерфейсам взаимодействия компонентов системы](#interaction)  
	4.4. [Требования к тестированию](#testing)  
...
**Серверная часть** представляет из себя кластер из 1 или более равноправных узлов, которые 
...
**Серверная часть** должна составлять не менее чем из 1 узла.
...
#### 3.2 Северная часть <a name="server"></a>
...
![Общий вид главного окна приложения](img/GUI.jpg)  
Рис. 1. Общий вид главного окна приложения

#### 4.3. Требования к интерфейсам взаимодействия компонентов системы <a name="interaction"></a>
...
#### 4.4. Требования к тестированию и приемке <a name="testing"></a>
